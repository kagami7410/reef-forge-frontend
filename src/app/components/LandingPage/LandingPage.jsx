...
const LandingPage = () => {
  ...
  return (
    <div className={`max-w-screen-2xl ${styles.landingPageContainer} mb-96`}>
      ...
      <div style={{ overflow: 'hidden' }} className='flex flex-col mt-3 md:mt-4 w-full rounded-xl bg-slate-400 '>


        <video className='object-cover rounded-xl ' style={{ object: 'cover', height: "560px" }} muted autoPlay loop >
      ...
      <div className='flex flex-col mt-3 md:mt-4 w-full rounded-lg'>
        ...
        <div className='w-full flex md:flex-row flex-col bg-slate-200 rounded-lg flex items-center justify-center'>
          <div className='md:w-2/5 w-5/6 m-8'>
          ...
          <div className='w-2/5 m-8'>
            ...
            <img className='rounded-xl h-96 w-96' style={{ object: 'cover' }} src={`https://storage.googleapis.com/fragracks-web-images/useCases/IMG20250607212926.jpg`} />
          </div>
          
          <div className='w-2/5 m-8'>


            <img className='rounded-xl h-96 w-96' style={{ object: 'cover' }} src={`https://storage.googleapis.com/fragracks-web-images/useCases/IMG20250607213428.jpg`} />
          </div>
      ...
      <div className='flex flex-col w-full mt-3 md:mt-4 bg-slate-100 rounded-md p-2 md:p-10'>
        <div className='flex'>
          <h1 className={`text-center text-xl  w-full mb-8 md:mb-4 ${styles.otherHeadline} md:text-2xl`}> Why buy from Reef-Forge? </h1>

        </div>
        <div className='md:flex-row flex-col flex items-center '>
          <div className='border w-4/5 p-4 border bg-slate-50 md:w-1/4 flex flex-col m-4 rounded-lg shadow-lg md:h-52 h-46  '>
            <div className='flex items-center md:mb-6 mb-2  justify-center'>
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="50px" viewBox="0 0 48 48">
